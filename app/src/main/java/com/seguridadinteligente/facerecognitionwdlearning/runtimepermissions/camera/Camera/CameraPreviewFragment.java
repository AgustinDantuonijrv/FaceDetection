...
import com.seguridadinteligente.facerecognitionwdlearning.R;
    ...
    public class CameraPreviewFragment extends Fragment {
        ...
        private CameraPreviewExample mPreview;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (mCamera == null || cameraInfo == null) {
                ...
                return inflater.inflate(R.layout.fragment_camera_unavaible, null);
            }
            ...
            mPreview = new CameraPreviewExample(getActivity(), mCamera, cameraInfo, displayRotation);
